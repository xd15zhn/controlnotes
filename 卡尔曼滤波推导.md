...
\frac{\partial J}{\partial B} &= -2y^{\top}+2x^{\top}A^{\top}+2B^{\top} =0\\
B &= \text{E}(y^{\top}-x^{\top}A^{\top})^{\top}=y-A\text{E}x \\
\frac{\partial J}{\partial A} &= -2xy^{\top}+2xx^{\top}A^{\top}+2xB^{\top} =0\\
\text{E}(Axx^{\top}) &= \text{E}(xy^{\top}-Bx^{\top}) \\
A &= \text{E}(y)=C_{xx}^{-1}C_{xy} \\
