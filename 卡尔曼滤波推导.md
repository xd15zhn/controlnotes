...
$$
其中$\widetilde{x}_2=x_2-\hat{x}_2=x_2-\text{E}(x_1|x_2)$，由投影定理，$x_1$与$\widetilde{x}_2$独立，$\widetilde{x}_2$称为**新息**。
证明：
...
(x_2-\hat{x}_2) \\
&= \cdots+\frac{C_{yx_2}-\displaystyle\frac{C_{x_1x_2}C_{yx_1}}{\text{D}x_1}}
...
&= \frac{C_{yx_2}\text{D}x_1-C_{x_1x_2}C_{yx_1}}
{\text{D}x_1\text{D}x_2-C_{x_1x_2}^2}
\end{aligned}
$$
